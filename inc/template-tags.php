...
if ( ! function_exists( 'chriswiegman_paging_nav' ) ) :
	 ...
	 */
	function chriswiegman_paging_nav( $query = null ) {
		...
		<nav class="navigation paging-navigation" role="navigation">
			...
			<div class="nav-links">
				...
				<?php if ( get_next_posts_link( null, $query->max_num_pages ) ) { ?>
					<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'chriswiegman' ), $query->max_num_pages ); ?></div>
				<?php } ?>
