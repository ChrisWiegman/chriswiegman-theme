...
}(jQuery, window), //Load Google Fonts
WebFontConfig = {
    google: {
        families: [ "Open+Sans:400,400italic,400,700,700italic:latin", "Roboto+Slab:700:latin" ]
    }
}, function() {
    ...
    a(this).scrollTop() > 10 ? a(".site-header").hasClass("scrolled") || a(".site-header").addClass("scrolled") : a(".site-header").hasClass("scrolled") && a(".site-header").removeClass("scrolled"), 
    //Add or removed header class on scroll
    a(window).scroll(function() {
        a(this).scrollTop() > 55 ? a(".site-header").hasClass("scrolled") || a(".site-header").addClass("scrolled") : a(".site-header").hasClass("scrolled") && a(".site-header").removeClass("scrolled");
    });
    var b = 0;
    a(".software-short").each(function() {
        a(this).height() > b && (b = a(this).height());
    }), a(".software-short").height(b);
}), /**
