 ...
 */
var drawMood = function(a, b) {
    a = a || 30, b = b || 0;
    var c, d, e = document.getElementById("mood-chart").getContext("2d"), f = "action=get_mood_data&nonce=" + cwMood.nonce + "&start=" + a + "&days=" + b;
    d = window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP"), 
    d.onreadystatechange = function() {
        if (d.readyState === XMLHttpRequest.DONE) if (200 === d.status) {
            if (!c) {
                var a = function(a) {
                    var b = jQuery("#chartjs-tooltip");
                    if (!a) return void b.css({
                        opacity: 0
                    });
                    var c = a.text.split(":");
                    switch (c[1].trim()) {
                    ...
                    b.removeClass("above below"), b.addClass(a.yAlign), b.html("<span>" + c[0] + ": " + c[1] + "</span>"), 
                    b.css({
                        opacity: 1,
                        left: a.chart.canvas.offsetLeft + a.x + "px",
                        top: a.chart.canvas.offsetTop + a.y + "px",
                        fontFamily: a.fontFamily,
                        fontSize: a.fontSize,
                        fontStyle: a.fontStyle
                    });
                };
                Chart.defaults.global.showScale = !1, Chart.defaults.global.responsive = !0, Chart.defaults.global.scaleOverride = !0, 
                Chart.defaults.global.scaleSteps = 5, Chart.defaults.global.scaleStepWidth = 1, 
                Chart.defaults.global.scaleStartValue = 0, Chart.defaults.global.customTooltips = a;
                var b = {
                ...
                c = new Chart(e).Bar(JSON.parse(d.responseText).data, b), // Update colors based on mood.
                c.datasets[0].bars.forEach(function(a) {
                    switch (a.value) {
                      case 1:
                        a.fillColor = "#c11b17";
                        break;
    ...
    }, d.open("POST", cwMood.ajaxurl, !0), d.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), 
    d.send(f);
};

drawMood();
//# sourceMappingURL=cw-mood.js.map