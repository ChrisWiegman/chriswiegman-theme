...
function init() {
	...
	add_filter( 'manage_location_posts_columns', $n( 'filter_manage_location_posts_columns' ) );

	// Edit each column as needed.
	add_action( 'manage_location_posts_custom_column', $n( 'action_manage_location_posts_custom_column' ), 10, 2 );
